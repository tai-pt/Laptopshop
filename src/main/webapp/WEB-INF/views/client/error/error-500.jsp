...
<head>
    <meta charset="UTF-8">
    <title>500 - Lỗi máy chủ | LaptopShop</title>
...
<div class="container text-center my-5">
    ...
    <h1 class="mt-4">Lỗi máy chủ</h1>
    <p class="lead mb-4">Đã có lỗi xảy ra trong hệ thống. Vui lòng thử lại sau hoặc liên hệ quản trị viên.</p>
