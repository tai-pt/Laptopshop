...
<head>
    <meta charset="UTF-8">
    <title>Lỗi hệ thống | LaptopShop</title>
...
<div class="container text-center my-5">
    <div class="display-1 text-danger fw-bold">
        <i class="fas fa-bug"></i> Oops!
    </div>
    <h1 class="mt-4">Đã xảy ra lỗi</h1>
    <p class="lead mb-4">Chúng tôi không thể xử lý yêu cầu của bạn vào lúc này. Vui lòng thử lại sau.</p>
